...
#   value       = var.create_lex_bot ? try(module.lex_bot[0].bot_alias_id, null) : null
# }
...
#   value       = var.create_lex_bot ? module.lex_bot[0].lex_bot_logs_bucket_name : null
# }

# output "lex_bot_logs_bucket_arn" {
#   description = "S3 bucket ARN for Lex bot logs"
#   value       = var.create_lex_bot ? module.lex_bot[0].lex_bot_logs_bucket_arn : null
# }
